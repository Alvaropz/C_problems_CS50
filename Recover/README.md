# Recover
#Credits: Description provided by CS50. Week 4 - Recover

Important to note: This is the main code (the actual code that I wrote).

In this project we will try to recover some "lost" images from a memory card.
